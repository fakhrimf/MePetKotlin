...
class ListProfileAdapter(private val petList: List<PetDetailProfile>, private val listener: ProfileClickListener) : RecyclerView.Adapter<ListProfileAdapter.PetViewHolder>() {
    ...
    inner class PetViewHolder(private val binding: ItemPetProfileBinding) : RecyclerView.ViewHolder(binding.root) {
